...
const workspaceStyle: CSSProperties = { display: 'grid', textAlign: 'left', gap: 4, padding: 12, border: '1px solid transparent', borderRadius: 9, background: 'none', color: 'inherit', cursor: 'pointer' }
