...
**当前事实基线**：26 个 change 已归档、22 个 spec 有效、`pnpm run check` 61 文件 / 512 测试全绿；`git status` 为 **62 个未跟踪 + 31 个已修改、全部未提交未推送**。
...
| # | 事项 | 说明 |
| --- | --- | --- |
| 19 | 提交 / 推送 / 主目录同步 | 当前 62 未跟踪 + 31 已修改，全部未提交未推送；需你确认精确范围 |
